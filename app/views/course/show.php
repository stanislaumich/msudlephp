...
<a href="/courses/<?php echo $course['id']; ?>/topics/create/" class="btn btn-outline-primary mb-3 me-1" data-bs-toggle="tooltip" title="Добавить тему"><i class="bi bi-plus-circle me-1"></i>Добавить тему</a>
<a href="/courses/<?php echo $course['id']; ?>/units/create/" class="btn btn-outline-primary mb-3" data-bs-toggle="tooltip" title="Добавить единицу"><i class="bi bi-plus-circle me-1"></i>Добавить единицу</a>
...
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <div class="mt-3">
            <strong>Единицы без темы:</strong>
